...
class FormCreateTask extends Component {
    ...
    render() {
        const { itemsHowLong, itemsPoints, dataForSelectInput, listTaskCate,
            hiddenCheckAssign, listMembers, keyMember,
            nameTask,
            assignMemberTask,
            dateTask,
            photoTask,
        ...
        console.log('message', this.props.messageAlert)
                ...
                <Layout className="site-layout">
                    <Header className="site-layout-background" style={{ padding: 0 }}>
                        <Row style={{ textAlign: "center" }}>
                            ...
                            <Col flex="auto">
                                <div className="title-header">Add Task</div>
                            </Col>
                        </Row>
                    </Header>
                    <Content style={{ margin: '20px 20px' }}>
                        <div className="site-layout-background container-add-task" style={{ padding: '20px 40px', minHeight: 360 }}>
                            <Form
                                                ...
                                                dropdownRender={menu => (
                                                    <div>
                                                        ...
                                                        <div style={{ display: 'flex', flexWrap: 'nowrap', padding: 8 }}>
                                                            <Input autoComplete="off" style={{ flex: 'auto' }} value={dataForSelectInput} placeholder="Number for minutes" onChange={this.onNameChange} />
                                                            <a
                                ...
                                <Form.Item name="assign-member" label={
                                    keyMember.length > 0 ?
                                        <div style={{ fontSize: 16, color: '#2295FF' }}><TeamOutlined style={{ fontSize: 17 }} />&nbsp;Assign</div> :
                                        <div style={{ fontSize: 16 }}><TeamOutlined style={{ fontSize: 17 }} />&nbsp;Assign</div>
                                ...
                                >
                                    <Input.TextArea name="notesTask" onChange={this.handleInputChange} placeholder="More detail information" cols={2} />
                                </Form.Item>
                                <Form.Item>
                                    <div className="button-add-task-form">
                                        <Button type="default" size="large" style={{ marginRight: 10 }}>Cancel</Button>
                                        <Button htmlType="submit" type="primary" size="large">Add</Button>
                                    </div>
                                </Form.Item>
                            </Form>
